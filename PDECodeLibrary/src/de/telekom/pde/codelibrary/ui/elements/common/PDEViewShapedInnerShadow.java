...
public class PDEViewShapedInnerShadow extends View {
    protected PDEDrawableShapedInnerShadow mDrawable;
    private final static String LOG_TAG = PDEViewShapedInnerShadow.class.getName();

    public PDEViewShapedInnerShadow(Context context){
        super(context);
        init();
    }

    public PDEViewShapedInnerShadow(Context context, AttributeSet attrs){
       super(context,attrs);
       init();
    }

    public PDEViewShapedInnerShadow(Context context, AttributeSet attrs, int defStyle){
        super(context,attrs,defStyle);
        init();
    }

    protected void init(){
        setDrawable(new PDEDrawableShapedInnerShadow());
    }
    ...
    public void setDrawable(PDEDrawableShapedInnerShadow drawable){
        ...
        if (drawable != null){
            ...
            if (clippingDrawableSet == false) {
                Log.e(LOG_TAG, "could not draw inner shadow");
            }
        }
    }
    ...
    public void setShadowOffset (PointF offset){
        mDrawable.setShadowOffset(offset);
    }

    public PointF getShadowOffset(){
        return mDrawable.getShadowOffset();
    }
