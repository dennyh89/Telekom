...
//----- constants ----------------------------------------------------------------------------------------------------
    public enum PDEDrawableScrollbarIndicativeType {
        ...
        PDEDrawablScrollbarIndicativeTypeVertical
    }
...
//----- init -----------------------------------------------------------------------------------------------------------
    ...
    public PDEDrawableScrollbarIndicative() {
        // default type
        mElementScrollbarType = PDEDrawableScrollbarIndicativeType.PDEDrawablScrollbarIndicativeTypeVertical;
        // init
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    public void setLayoutHeight(int height) {
        ...
        if (mElementScrollbarType == PDEDrawableScrollbarIndicativeType.PDEDrawablScrollbarIndicativeTypeVertical) {
            // anything to do?
