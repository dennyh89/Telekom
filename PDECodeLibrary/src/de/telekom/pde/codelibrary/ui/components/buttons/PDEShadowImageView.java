...
// todo: discuss with Klaus if this class is needed.

/// @cond INTERNAL_UNUSED_CLASS
...
public class PDEShadowImageView extends ImageView {
    ...
    private final static String LOG_TAG = "PDEShadowImageView";
    ...
    public void setOffset (int x, int y) {
        if (DEBUG_OUT) Log.d(LOG_TAG, "setOffset x:"+x+" y:"+y);
        mOffset.set(x, y);
    }
