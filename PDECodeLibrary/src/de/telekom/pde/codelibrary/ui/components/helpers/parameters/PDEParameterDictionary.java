...
//----- parameter access -----------------------------------------------------------------------------------------------
     ...
     *
     * @return The parameter or nil if it does not exist.
     */
...
//----- class helpers --------------------------------------------------------------------------------------------------
     ...
     */
    public static boolean areParametersEqual(PDEParameterDictionary dictionary1,
                                             PDEParameterDictionary dictionary2,
